...

{
  ...
  "agentComment": "宅地建物取引士としての実務コメント(200〜250文字程度)。前半はこのエリアのデータの要点を断定調で述べ(「〜です」「〜となっています」。「〜と感じています」「〜と確認しています」の繰り返しは禁止)、初めて投資する方への具体的な提案や一言を加えること。特定物件の推奨や将来の価格保証はしない。後半に次の2文を必ずそのまま追加すること:『表面利回りの試算では概ね6%前後が目安ですが、これは一律の想定家賃に基づく参考値であり、エリア間の優劣を示すものではありません。また、鉄骨造・RC造の中古マンションは木造の戸建てより融資期間を長く組みやすい傾向があるため、資金計画の参考にしてください。』",
