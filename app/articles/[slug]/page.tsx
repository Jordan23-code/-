      ...
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow border border-slate-200 p-8">
        ...
        {article.sections.agentComment && (
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs font-bold text-blue-700 mb-1">🏠 宅建士コメント</p>
        ...
        <section className="mb-6">
          <h2 className="font-bold text-lg mb-2">相場データ(国土交通省 不動産情報ライブラリより)</h2>
        ...
        {article.sections.propertyTrend && (
          <Section title="今、どんな物件が動いているか">{article.sections.propertyTrend}</Section>
        )}
        ...
        <Section title="表面利回りの試算例">{article.sections.yieldSimulation}</Section>

        {article.sections.lowEntryPitch && (
          <section className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
            <h2 className="font-bold text-lg mb-2 text-emerald-800">総額を抑えて始めたい方へ</h2>
